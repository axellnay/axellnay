...
### 🛠️ Projets (SAÉ)
* **SAÉ 1.01 & 1.02 :** Création de mini-jeu à deux en python. Comparaison d'algorithmes de tries.
* **SAÉ 1.03 :** Découverte de l'environnement Linux. Mise en situation de gestion d'une bibliothèque
* **SAÉ 1.04 :** Apprentissage du SQL pour concevoir et manipuler des données efficacement. Visualisation des données via SQLPad
